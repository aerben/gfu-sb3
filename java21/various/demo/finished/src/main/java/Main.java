import digital.erben.various.PrivateInterface;
...
public class Main {
    ...
    public static void main(String[] args) {
        var impl = new PrivateInterface(){ // Typ-Inferenz: In vielen Fällen kann der Compiler den Typ einer Variable selbst ermitteln
        };
        impl.check();
