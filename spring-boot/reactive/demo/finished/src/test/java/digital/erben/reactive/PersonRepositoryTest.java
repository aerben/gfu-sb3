...
public class PersonRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        this.testPeople = personRepository.deleteAll()
            .thenMany(personRepository.saveAll(List.of(randomPerson(), randomPerson(), randomPerson())))
    ...
    @Test
    void testFindOne() {
        StepVerifier.create(personRepository.findById(this.testPeople.getFirst().getId()))
            .expectNextMatches(person -> person.equals(this.testPeople.getFirst()))
            .verifyComplete();
    }
